...
CREATE TABLE MEDICAMENTO_USUARIO (
	...
	ON DELETE CASCADE ON UPDATE CASCADE,--ON DELETE CASCADE PORQUE SI BORRO EL USUARIO SE TIENE QUE BORRAR TO LO RELACIONAO CON EL
...
--	FECHAFIN_ESTIMADA DATE NOT NULL,	--PODRIA SER UNA COLUMNA CALCULADA
	FECHAFIN_REAL DATE NULL

	CONSTRAINT PK_CICLOMENSTRUAL PRIMARY KEY (ID),
	CONSTRAINT FK_CICLOMENSTRUAL_USUARIO FOREIGN KEY (ID_USUARIO)
	REFERENCES USUARIO(NICK) --ON DELETE CASCADE PORQUE SI BORRO EL USUARIO SE TIENE QUE BORRAR TO LO RELACIONAO CON EL
...
CREATE TABLE REVISIONMEDICA (
	...
	FECHA_CITA_ACTUAL DATE NOT NULL,
...
CREATE TABLE REVISIONPERSONAL_FLUJOVAGINAL (
	...
	CONSTRAINT FK_REVISIONPERSONALFLUJOVAGINAL_REVISIONPERSONAL FOREIGN KEY (ID_REVISIONPERSONAL)
	REFERENCES REVISIONPERSONAL(ID)
	ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT FK_REVISIONPERSONALFLUJOVAGINAL_FLUJOVAGINAL FOREIGN KEY (ID_FLUJOVAGINAL)
...
CREATE TABLE REVISIONPERSONAL_SEXO (
	...
	CONSTRAINT FK_REVISIONPERSONALSEXO_REVISIONPERSONAL FOREIGN KEY (ID_REVISIONPERSONAL)
	REFERENCES REVISIONPERSONAL(ID)
	ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT FK_REVISIONPERSONALSEXO_SEXO FOREIGN KEY (ID_SEXO)
	REFERENCES SEXO(ID)
	ON DELETE NO ACTION ON UPDATE CASCADE,
